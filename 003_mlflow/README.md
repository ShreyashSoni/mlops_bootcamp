...
`mlflow run https://github.com/<user_name>/ml-flow-project --experiment-name Loan_prediction` 
...
`mlflow models serve -m ./mlruns/636758781795674813/91ef1ea3f63d40a7a33c4251dd088618/artifacts/RandomForestClassifier --port 9000`
...
-port 5001
`mlflow server --host 0.0.0.0 --port 5001 --backend-store-uri mysql://root:root@localhost/db_mlflow --default-artifact-root $PWD/mlruns`

- port 5000
`mlflow server --host 0.0.0.0 --port 5000 --backend-store-uri mysql://root:root@localhost/db_mlflow --default-artifact-root $PWD/mlruns`
